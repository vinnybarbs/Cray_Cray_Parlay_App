-- mv_public_record v4: add a last_3d period bucket.
-- The digest hero gains a clickable Sharp Take period toggle (3d / 7d /
-- 30d / all) so a heater is visible at a glance. Same population and
-- domain-separated dedup as v3, one more period slice. Applied to prod
-- 2026-08-05 via MCP.
