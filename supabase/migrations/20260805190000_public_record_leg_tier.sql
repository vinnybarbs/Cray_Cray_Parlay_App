...
-- the parlay builder. Like Trap, Leg is its own dedup domain and appears
-- ONLY in the tier dimension, never in overall/sport/bet_type. Unlike
-- Trap, its outcomes read straight: won means the leg hit. Applied to
-- prod 2026-08-05 via MCP.
