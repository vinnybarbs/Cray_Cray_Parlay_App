...
/** Posts to the webhook. Resolves always; never throws. */
async function sendSharpTakeAlert(details) {
  ...
  try {
    const res = await fetch(url, {
      ...
      body: JSON.stringify({ content: formatSharpTakeAlert(details) }),
    });
...
module.exports = { shouldAlertSharpTake, formatSharpTakeAlert, sendSharpTakeAlert };
