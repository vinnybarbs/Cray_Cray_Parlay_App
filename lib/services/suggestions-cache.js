...
const { sportDayISO } = require('./sport-day.js');
...
class SuggestionsCache {
  ...
  getGameDate(dateRange) {
    // Eastern game-day: the UTC date used to roll the cache key at 5-6pm MT,
    // splitting one evening slate across two cache days.
    return sportDayISO();
  }
