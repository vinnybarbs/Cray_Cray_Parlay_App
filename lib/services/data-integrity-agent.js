...
const JSON_RULES = `Your final message must END with a single JSON object. No markdown fences, no prose after the closing brace. If you could not verify something, omit it rather than guessing. Include a source URL or site name for every item you report. WRITING STYLE: Plain punctuation only. Never use em dashes, en dashes, or semicolons in your output. Use periods and commas.`;
