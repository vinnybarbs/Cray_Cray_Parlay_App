...
class SportsIntelligenceService {
  ...
  generateTagline(summary, type) {
    ...
    switch (type) {
      case 'injuries':
        return this.generateInjuryTagline(summary);
      case 'analyst_picks':
        return this.generateAnalystTagline(summary);
      case 'team_news':
        return this.generateNewsTagline(summary);
      case 'betting_trends':
        return this.generateTrendsTagline(summary);
      default:
