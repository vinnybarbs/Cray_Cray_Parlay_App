...
class NewsSummarizer {
  ...
  /**
   * Use Claude to extract betting-relevant insights from articles
   */
...
Return JSON:
{
  ...
  "sentiment": "positive|negative|neutral"
      ...
      const parsed = await complete({
        ...
        system: 'You are a sports betting analyst. Extract only betting-relevant facts from news. Return valid JSON only.',
