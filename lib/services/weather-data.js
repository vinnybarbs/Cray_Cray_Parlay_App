...
const VENUES = {
  ...
  // NFL (weather moves totals and kicking games; added for the 2026 season)
  'arizona cardinals': { stadium: 'State Farm Stadium', lat: 33.528, lon: -112.263, roof: 'retractable' },
  'atlanta falcons': { stadium: 'Mercedes-Benz Stadium', lat: 33.755, lon: -84.401, roof: 'retractable' },
  'baltimore ravens': { stadium: 'M&T Bank Stadium', lat: 39.278, lon: -76.623, roof: 'none' },
  'buffalo bills': { stadium: 'Highmark Stadium', lat: 42.774, lon: -78.787, roof: 'none' },
  'carolina panthers': { stadium: 'Bank of America Stadium', lat: 35.226, lon: -80.853, roof: 'none' },
  'chicago bears': { stadium: 'Soldier Field', lat: 41.862, lon: -87.617, roof: 'none' },
  'cincinnati bengals': { stadium: 'Paycor Stadium', lat: 39.095, lon: -84.516, roof: 'none' },
  'cleveland browns': { stadium: 'Huntington Bank Field', lat: 41.506, lon: -81.699, roof: 'none' },
  'dallas cowboys': { stadium: 'AT&T Stadium', lat: 32.748, lon: -97.093, roof: 'retractable' },
  'denver broncos': { stadium: 'Empower Field at Mile High', lat: 39.744, lon: -105.020, roof: 'none' },
  'detroit lions': { stadium: 'Ford Field', lat: 42.340, lon: -83.046, roof: 'dome' },
  'green bay packers': { stadium: 'Lambeau Field', lat: 44.501, lon: -88.062, roof: 'none' },
  'houston texans': { stadium: 'NRG Stadium', lat: 29.685, lon: -95.411, roof: 'retractable' },
  'indianapolis colts': { stadium: 'Lucas Oil Stadium', lat: 39.760, lon: -86.164, roof: 'retractable' },
  'jacksonville jaguars': { stadium: 'EverBank Stadium', lat: 30.324, lon: -81.637, roof: 'none' },
  'kansas city chiefs': { stadium: 'GEHA Field at Arrowhead Stadium', lat: 39.049, lon: -94.484, roof: 'none' },
  'las vegas raiders': { stadium: 'Allegiant Stadium', lat: 36.091, lon: -115.184, roof: 'dome' },
  'los angeles chargers': { stadium: 'SoFi Stadium', lat: 33.953, lon: -118.339, roof: 'dome' },
  'los angeles rams': { stadium: 'SoFi Stadium', lat: 33.953, lon: -118.339, roof: 'dome' },
  'miami dolphins': { stadium: 'Hard Rock Stadium', lat: 25.958, lon: -80.239, roof: 'none' },
  'minnesota vikings': { stadium: 'U.S. Bank Stadium', lat: 44.974, lon: -93.258, roof: 'dome' },
  'new england patriots': { stadium: 'Gillette Stadium', lat: 42.091, lon: -71.264, roof: 'none' },
  'new orleans saints': { stadium: 'Caesars Superdome', lat: 29.951, lon: -90.081, roof: 'dome' },
  'new york giants': { stadium: 'MetLife Stadium', lat: 40.813, lon: -74.074, roof: 'none' },
  'new york jets': { stadium: 'MetLife Stadium', lat: 40.813, lon: -74.074, roof: 'none' },
  'philadelphia eagles': { stadium: 'Lincoln Financial Field', lat: 39.901, lon: -75.167, roof: 'none' },
  'pittsburgh steelers': { stadium: 'Acrisure Stadium', lat: 40.447, lon: -80.016, roof: 'none' },
  'san francisco 49ers': { stadium: "Levi's Stadium", lat: 37.403, lon: -121.970, roof: 'none' },
  'seattle seahawks': { stadium: 'Lumen Field', lat: 47.595, lon: -122.332, roof: 'none' },
  'tampa bay buccaneers': { stadium: 'Raymond James Stadium', lat: 27.976, lon: -82.503, roof: 'none' },
  'tennessee titans': { stadium: 'Nissan Stadium', lat: 36.166, lon: -86.771, roof: 'none' },
  'washington commanders': { stadium: 'Northwest Stadium', lat: 38.908, lon: -76.864, roof: 'none' },
  // MLS
...
/**
 * Football totals adjustment (points, negative = lean under) from a
 * weather row. Wind is the factor that moves football totals: 15+ mph
 * degrades the passing and kicking game, 25+ wrecks it. Heavy
 * precipitation adds a smaller drag. Domes and missing data return 0.
 * Conservative seeds; the preseason shadow window measures them.
 */
function footballTotalPenalty(row) {
  if (!row || row.roof === 'dome') return 0;
  let penalty = 0;
  if (row.wind_mph != null) {
    if (row.wind_mph >= 25) penalty -= 4;
    else if (row.wind_mph >= 15) penalty -= 2;
  }
  if (row.precip_chance_pct != null && row.precip_chance_pct >= 60) penalty -= 1.5;
  return penalty;
}
