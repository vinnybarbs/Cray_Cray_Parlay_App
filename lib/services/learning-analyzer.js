      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are an expert sports betting analyst who learns from outcomes to improve future predictions. Analyze picks objectively and extract actionable lessons. Be concise and data-driven.'
            },
            {
              role: 'user',
