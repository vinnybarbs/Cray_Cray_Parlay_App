...
class EdgeCalculator {
  ...
  async calculateEdge(game) {
    ...
    // ------------------------------------------------------------------
    const venueAdjs = this._venueSplitAdjustments(homeStandings, awayStandings, sportName, game.home_team, game.away_team, dial('venue_weight'));
  ...
  _venueSplitAdjustments(homeStandings, awayStandings, sport, homeTeamName, awayTeamName, venueWeight = null) {
    const out = [];
