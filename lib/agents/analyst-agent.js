...
- DO NOT INVENT player stats, team assignments, injury info, or game facts
- If you see "J.K. Dobbins" in a "Denver Broncos @ New York Jets" game, DO NOT guess which team he plays for. Check the Context research for his actual team or DO NOT USE HIM.
- If Context doesn't mention a player's recent performance, DO NOT make it up ("averaging X touchdowns", "scored in last 3 games", etc.)
- If you're unsure about ANY fact, DO NOT include that player/bet
- ONLY use information explicitly stated in the Context section below
- When picking player props, the player MUST play for either the Away team OR the Home team (check Context to confirm which one)
- Example violations that will FAIL: "Josh Jacobs plays for Cincinnati" (he plays for Green Bay), "Tyjae Spears averaging 2 TDs/game" (made up stat), "D'Andre Swift plays for Commanders" (plays for Bears)
