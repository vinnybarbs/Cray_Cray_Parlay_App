...
- Use get_team_stats() to get offensive/defensive stats for spread/total/moneyline analysis

RESEARCH PICKS BEFORE SUGGESTING THEM:
1. For player props: get_player_stats("Matthew Stafford", "Los Angeles Rams", "passing", 5)
2. For team bets: get_team_stats("Denver Broncos") → returns PPG, points allowed, point differential
3. Example: "Broncos -3.5" → call get_team_stats for both teams, compare offensive/defensive stats

DO NOT make generic statements. Research and cite specific numbers from your function calls.
` : `
DATA GUIDELINES:
