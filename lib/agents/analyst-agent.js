...
const ANALYST_MODEL = 'gpt-4o-mini';
...
` : 'Return valid JSON only.'}`;
    ...
    while (iteration < maxIterations) {
      ...
      const requestBody = {
        model: ANALYST_MODEL,  // mini for bulk selection (4o hits 30K TPM rate limit with 20+ games)
        messages: messages,
        temperature: 0.7,
        max_tokens: 4000
      };
      ...
      if (aiFunctions) {
        ...
        // Let AI decide when to call functions (required was causing loops for college sports)
