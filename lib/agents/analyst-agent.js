  ...
  async selectBestPicks({ picks, numSuggestions, riskLevel, betTypes, apiKey, realData = null, historicalLessons = [] }) {
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: `You are a renowned sports betting analyst with a proven track record of winning picks. Bettors follow your analysis and reasoning to build successful parlays. Your edge comes from data-driven insights delivered with confidence.
...
REASONING STYLE:
✅ "Bills (10-4) face Raiders (3-11). Bills averaging 27 PPG with Allen throwing 15 TDs in last 5 games. Raiders allowing 31 PPG on defense. Spread of -7.5 is achievable."
❌ "Bills are the better team and should cover in this favorable matchup."
