...
`.trim();
  ...
  async selectBestPicks({ picks, numSuggestions, riskLevel, betTypes, apiKey, realData = null, historicalLessons = [], supabase = null }) {
    ...
    const systemPrompt = `You are a data-driven sports betting analyst. Your picks are backed ONLY by verified data provided to you. You NEVER invent statistics, records, player names, or trends.
