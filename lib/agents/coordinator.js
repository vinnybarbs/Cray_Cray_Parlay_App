...
class MultiAgentCoordinator {
  ...
  async gatherRealDataForAI(games, request) {
    ...
    try {
      ...
      if (this.supabase) {
        const { data: teamRecords } = await this.supabase
      ...
      if (this.supabase) {
        ...
        console.log(`  ✅ Loaded ${Object.values(realData.recentNews).flat().length} articles for ${Object.keys(realData.recentNews).length} teams`);
      }
