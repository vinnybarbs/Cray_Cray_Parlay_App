...
class TargetedOddsAgent {
  ...
  async fetchFromBook(bookmaker, sports, betTypes, now, rangeEnd, { fastMode = false, capCount = 12 } = {}) {
    ...
    throw new Error(`No ${sportNames} games available in cache. This sport may be out of season or games haven't been cached yet. Try NFL which is currently in season.`);
