...
function validateParlayRequest(req, res, next) {
  ...
  // Validate aiModel (optional, and only 'openai' supported)
  if (typeof aiModel !== 'undefined' && aiModel !== 'openai') {
    errors.push('aiModel must be "openai" if provided');
  }
...
function sanitizeInput(req, res, next) {
  ...
  if (!req.body.aiModel) req.body.aiModel = 'openai';
