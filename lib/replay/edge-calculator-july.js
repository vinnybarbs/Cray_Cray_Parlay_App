/**
 * FROZEN COPY of lib/services/edge-calculator.js at commit 639cff1
 * (2026-07-22), the last July version of the formula: record blend base
 * with home advantage, recent form, schedule strength, venue splits,
 * streak and seed, no market anchor, no damping, July reliability
 * multipliers. Kept verbatim (one require path adjusted) so the replay
 * harness can answer "would July's formula have won these games" with
 * the actual July code, not a reconstruction. Do not edit the math here.
 */
...
class EdgeCalculator {
  ...
  async calculateEdge(game) {
    ...
    try {
      const ATSTracker = require('../services/ats-tracker');
