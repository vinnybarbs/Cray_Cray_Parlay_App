...
Directive 21 (the dial freeze through 2026-09-27) has a check_sql too: any model_weight_changes row in the window whose source is not one of its allowed sources (sunday-sweep-approved, promote_ready_markets, weekly-refresh, directive-10-restore, props-v2-seed, owner-approved-2026-09-15) is a finding, name it. Two routines also leave witnesses to read here: weekly-replay-sweep (Sunday 23:00 MT) logs job_name replay-formula with candidates_filed in its details and files "Sunday sweep candidate" rows in build_queue; promote-ready-markets (daily 07:00 MT) writes an agent_reports row from agent promote-ready-markets the morning it opens a market, so a new row there is a go-live to report at the top of the brief.
