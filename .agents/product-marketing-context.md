...
- ✅ Reverent about the math ("the model disagreed by 12pp — we don't ignore that")
...
**Tier label format (decided 2026-05-11):** Hybrid — analytical primary label
...
| "Sportsbooks know what they're doing — there's no edge" | Conventional wisdom | True for ML on heavy favorites; we openly show those as Skip. Edge exists on spreads/dogs/props where we deliberately specialize |
| "Will my data be safe?" | Sportsbooks have huge data brokerage issues | Public-facing app, no betslip integration yet — easy to address transparently |
